...
```json
{
  ...
  "repository": {
    ...
    "benchmark_tag": "benchmark-gcp-l4-matched-v11",
    ...
    "release_tag": "vgr-gcp-l4-matched-v11",
    "release_url": "https://github.com/cybernetic-physics/vectorized-gaussian-renderer-public/releases/tag/vgr-gcp-l4-matched-v11",
...
python3 scripts/verify_publication_code_freeze.py \
  --benchmark-ref benchmark-gcp-l4-matched-v11 \
