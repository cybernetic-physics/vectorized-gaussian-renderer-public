...
python3 publication/publish_immutable_r2.py \
  ...
  --file /path/to/gcp-l4-matched-v3.tar \
  --key evidence/gcp-l4-matched-v3/<full-archive-sha256>.tar \
  --download-name gcp-l4-matched-v3.tar \
  --receipt /path/to/gcp-l4-matched-v3.r2-receipt.json
```
...
python3 publication/verify_public_release.py r2 \
  ...
  --output /path/to/gcp-l4-matched-v3.r2-public.json
```
...
python3 publication/verify_public_release.py github \
  ...
  --benchmark-tag benchmark-gcp-l4-matched-v3 \
  --benchmark-commit <benchmark-commit> \
  --release-tag vgr-gcp-l4-matched-v3 \
  --final-merge-commit <full-merge-commit> \
  --article post.md \
  --readme README.md \
  --output /path/to/gcp-l4-matched-v3.github-public.json
```
