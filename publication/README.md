...
python3 publication/publish_immutable_r2.py \
  ...
  --file /path/to/gcp-l4-matched-v7.tar \
  --key evidence/gcp-l4-matched-v7/<full-archive-sha256>.tar \
  --download-name gcp-l4-matched-v7.tar \
  --receipt /path/to/gcp-l4-matched-v7.r2-receipt.json
```
...
python3 publication/verify_public_release.py r2 \
  --receipt /path/to/gcp-l4-matched-v7.r2-receipt.json \
  --archive /path/to/gcp-l4-matched-v7.tar \
  --output /path/to/gcp-l4-matched-v7.r2-public.json
```
...
python3 publication/verify_public_release.py github \
  ...
  --article post.md \
  --readme README.md \
  --output /path/to/gcp-l4-matched-v7.github-public.json
```
